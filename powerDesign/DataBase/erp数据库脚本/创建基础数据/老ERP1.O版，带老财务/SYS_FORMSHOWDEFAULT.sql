...
insert into SYS_FORMSHOWDEFAULT (ID, C_NAME, C_CONTROL_ID, I_OPER_ID, C_OPER_NAME, D_INSERT_DATE, I_OPER_MODIFYID, C_OPER_MODIFYNAME, D_MODIFY_DATE, I_DEL, C_ALIASCODE)
values (6, '财务管理', 'financialbaseinfo', 1, 'admin', to_date('04-07-2011 12:04:19', 'dd-mm-yyyy hh24:mi:ss'), 1, 'admin', to_date('09-08-2011 10:46:18', 'dd-mm-yyyy hh24:mi:ss'), 0, 'cwgl');
insert into SYS_FORMSHOWDEFAULT (ID, C_NAME, C_CONTROL_ID, I_OPER_ID, C_OPER_NAME, D_INSERT_DATE, I_OPER_MODIFYID, C_OPER_MODIFYNAME, D_MODIFY_DATE, I_DEL, C_ALIASCODE)
...
insert into SYS_FORMSHOWDEFAULT (ID, C_NAME, C_CONTROL_ID, I_OPER_ID, C_OPER_NAME, D_INSERT_DATE, I_OPER_MODIFYID, C_OPER_MODIFYNAME, D_MODIFY_DATE, I_DEL, C_ALIASCODE)
values (10, '财务业务', 'financialbusiness', 1, 'admin', to_date('09-08-2011 11:15:13', 'dd-mm-yyyy hh24:mi:ss'), 1, 'admin', to_date('09-08-2011 11:15:13', 'dd-mm-yyyy hh24:mi:ss'), 0, 'cwyw');
insert into SYS_FORMSHOWDEFAULT (ID, C_NAME, C_CONTROL_ID, I_OPER_ID, C_OPER_NAME, D_INSERT_DATE, I_OPER_MODIFYID, C_OPER_MODIFYNAME, D_MODIFY_DATE, I_DEL, C_ALIASCODE)
...
insert into SYS_FORMSHOWDEFAULT (ID, C_NAME, C_CONTROL_ID, I_OPER_ID, C_OPER_NAME, D_INSERT_DATE, I_OPER_MODIFYID, C_OPER_MODIFYNAME, D_MODIFY_DATE, I_DEL, C_ALIASCODE)
values (82, '蒸汽锅炉', 'boiler', 1, 'admin', to_date('30-01-2012 17:16:24', 'dd-mm-yyyy hh24:mi:ss'), 1, 'admin', to_date('30-01-2012 17:16:24', 'dd-mm-yyyy hh24:mi:ss'), 0, 'zqgl');
commit;
